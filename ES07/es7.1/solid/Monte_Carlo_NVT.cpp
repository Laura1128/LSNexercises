...
void Print(){
	ofstream instant_Epot;
	ofstream instant_P;
  	instant_Epot.open ("instant_Epot", ios::app);
  	instant_P.open ("instant_P", ios::app);

	instant_Epot<<walker[iv]/(double)npart + vtail<<endl;
	instant_P<<rho * temp + (walker[iw] + (double)npart * ptail) / vol <<endl;
